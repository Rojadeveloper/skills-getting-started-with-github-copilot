...
activities = {
    ...
    "Tennis": {
        "description": "Individual and doubles tennis matches and practice",
    ...
    "Drama Club": {
        "description": "Theater performances, acting workshops, and scriptwriting",
    ...
    "Robotics Team": {
        "description": "Build and program robots for competition and innovation challenges",
